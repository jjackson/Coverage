...
def create_statistics_report(excel_file=None, service_delivery_csv=None, coverage_data=None):
    ...
    flws_with_50_plus_dus = coverage_data.delivery_units_df[coverage_data.delivery_units_df['service_area_id'].isin(sas_50_plus_ids)]['flw'].unique()
    ...
    flws_with_35_to_50_dus = coverage_data.delivery_units_df[coverage_data.delivery_units_df['service_area_id'].isin(sas_35_to_50_ids)]['flw'].unique()
...
def create_html_report(delivery_df, service_df, figures, coverage_data):
    ...
    # Create FLW data for filtering
    flw_data = delivery_df.groupby('flw').agg({
